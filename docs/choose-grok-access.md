...
> 信息核验日期：2026-08-31。方案、价格和权益可能变化，最终以官方页面与账号结算页为准。
...
| 更高强度、希望比较 Grok Bot 等资格 | SuperGrok Plus | 当前公开价为 `$100/month` | Bot、模型、额度和地区是否适用于我的账号？ |
...
- xAI 定价页直接显示 Free 为 `$0/month`、SuperGrok 为 `$30/month`、SuperGrok Plus 为 `$100/month`；
- 同一页面列出 SuperGrok Heavy，但当前公开页隐藏 Heavy 金额；
...
因此可以严谨地说：发布时有报道明确记录 300 美元月价，当前 App Store 仍显示 300 美元内购项；但当前 xAI 定价页不公开 Heavy 金额。按历史发布价计算三个月为 900 美元；这不代表 xAI 当前结账价，地区、平台、税费、促销和周期仍以实际结账页为准。

没有海外银行卡时，本地结算可以减少办卡和跨境支付步骤，但仍要比较交付方式。本人账号人工开通更利于保留账号控制权；已开好 Heavy 的成品账号更省步骤，但控制权、恢复权和条款风险更高。AIXiamo 当前 1个月 ¥380、3个月 ¥580 的日期化事实与唯一商业承接链接见仓库 README。
